...
The comand interpreter is  the Shell. In this case, we want to be able to manage the objects of our project:
...
Updates an instance based on the class name and id:
	...
	(hbnb) update BaseModel 1234-1234-1234 email "j.uwase1@alustudent.com"
...
# Authors
* Aristide Isingizwe - <a.isingizwe@alustudent.com>
* Jeannine Uwase- <j.uwase1@alustudent.com>
